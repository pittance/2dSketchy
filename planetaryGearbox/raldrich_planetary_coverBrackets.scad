...
//add flange
		difference() {
			translate([-cover_size[x]/2+2,cover_size[y]/2,0.75*cover_size[z]]) cube([cover_size[x]-4,10,0.25*cover_size[z]]);
			translate([-cover_size[x]/2+2,cover_size[y]/2,0.75*cover_size[z]]) {
				translate([5,5,0]) cylinder(h=10,r=1.5,$fn=12, center=true);
				translate([cover_size[x]-4-5,5,0]) cylinder(h=10,r=1.5,$fn=12, center=true);
			}	
		}

//add flange
		difference() {
			translate([-cover_size[x]/2+2,-cover_size[y]/2-10,0.75*cover_size[z]]) cube([cover_size[x]-4,10,0.25*cover_size[z]]);
			translate([-cover_size[x]/2+2,-cover_size[y]/2-10,0.75*cover_size[z]]) {
				translate([5,5,0]) cylinder(h=10,r=1.5,$fn=12, center=true);
				translate([cover_size[x]-4-5,5,0]) cylinder(h=10,r=1.5,$fn=12, center=true);
			}	
		}
